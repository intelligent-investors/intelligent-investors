...
<div>
  ...
  },
  {
    ...
    "answer": [
      { "value": "0.0011", "correct": "true", "explanation": "Corr(RA,RB) = Cov(RA,RB)/[σ(RA)][σ(RB)]; σ^2(RA) = [Cov(RA,RB)/(σ(RB)Corr(RA,RB))]^2 = [0.0043/((0.26)(0.5))]^2 = 0.0331^2 = 0.0011." },
  ...
  },
  {
    ...
    "answer": [
      ...
      { "value": "70%", "correct": "true", "explanation": "This is an application of Bayes’ formula. The updated probability that earnings per share are greater than $2 is 28%/(28%+12%) = 70%" }
    ]
  },
  {
