...
* A. The $$z$$-statistic at $$\alpha$$ with $$n$$ degrees of freedom.  
...
* B. Only a $$z$$-statistic at $$\alpha$$ with $$n$$ degrees of freedom.  
...
7. Annual returns on small stocks have a population mean of 12\% and a population standard deviation of 20%. If the returns are normally distributed, a 90\% confidence interval on mean returns over a 5-year period is:  
