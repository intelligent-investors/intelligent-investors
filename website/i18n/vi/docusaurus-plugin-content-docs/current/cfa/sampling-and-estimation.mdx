...
### J: Tính toán và diễn giải khoảng tin cậy cho giá trị trung bình của tổng thể, với điều kiện phân phối chuẩn có 1) phương sai tổng thể đã biết, 2) phương sai tổng thể chưa biết, hoặc 3) phương sai tổng thể chưa biết và kích thước mẫu lớn.

Ước lượng khoảng tin cậy tạo ra một phạm vi giá trị mà trong đó giá trị thực của tham số sẽ nằm, với xác suất là $$1 - \alpha$$. Ở đây, alpha, $$\alpha$$, được gọi là mức ý nghĩa cho khoảng tin cậy, và xác suất $$1 - \alpha$$ được gọi là mức độ tin cậy. Ví dụ, chúng ta có thể ước tính rằng giá trị trung bình của tổng thể các biến ngẫu nhiên sẽ nằm trong khoảng từ 15 đến 25 với mức độ tin cậy 95$$\%$$, hoặc ở mức ý nghĩa 5$$\%$$.

Các khoảng tin cậy thường được xây dựng bằng cách cộng hoặc trừ một giá trị thích hợp từ ước lượng điểm. Nói chung, các khoảng tin cậy có dạng như sau:
...
- hệ số tin cậy = số phụ thuộc vào phân phối mẫu của ước lượng điểm và xác suất rằng ước lượng điểm rơi vào khoảng tin cậy, $$1 - \alpha$$
- sai số chuẩn = sai số chuẩn của ước lượng điểm

Nếu tổng thể có phân phối chuẩn với phương sai đã biết, một khoảng tin cậy cho giá trị trung bình của tổng thể có thể được tính như sau:
...
trong đó:
- $$\bar{x}$$ = ước lượng điểm của giá trị trung bình tổng thể (giá trị trung bình mẫu).
- $$z_{\alpha/2}$$ = hệ số tin cậy, một biến ngẫu nhiên chuẩn tắc mà xác suất ở phía đuôi phải của phân phối là $$\alpha/2$$. Nói cách khác, đây là z-score mà để lại $$\alpha/2$$ của xác suất ở đuôi trên.
- $$\frac{\sigma}{\sqrt{n}}$$ = sai số chuẩn của giá trị trung bình mẫu, trong đó $$\sigma$$ là độ lệch chuẩn đã biết của tổng thể, và $$n$$ là kích thước mẫu.

Các hệ số tin cậy phân phối chuẩn tắc được sử dụng phổ biến nhất là:

$$
z_{\alpha/2} = 1.645 \text{ cho khoảng tin cậy 90\% (mức ý nghĩa là 10\%, 5\% mỗi đuôi).}
$$
$$
z_{\alpha/2} = 1.960 \text{ cho khoảng tin cậy 95\% (mức ý nghĩa là 5\%, 2.5\% mỗi đuôi).}
$$
$$
z_{\alpha/2} = 2.575 \text{ cho khoảng tin cậy 99\% (mức ý nghĩa là 1\%, 0.5\% mỗi đuôi).}
$$

Những con số này có quen thuộc không? Chúng nên quen thuộc! Trong phần ôn tập về các phân phối xác suất phổ biến, chúng ta đã tìm thấy xác suất dưới đường cong chuẩn chuẩn từ z = -1.96 đến z = +1.96 là 0.95, hoặc 95\%. Do tính đối xứng, điều này để lại xác suất 0.025 dưới mỗi đuôi của đường cong vượt qua z = -1.96 hoặc z = +1.96, tổng cộng là 0.05, hoặc 5\%—chính xác là những gì chúng ta cần cho một mức độ ý nghĩa là 0.05, hoặc 5\%.

:::info[**VÍ DỤ: Khoảng tin cậy**]
Hãy xem xét một bài kiểm tra thực hành được thực hiện cho 36 thí sinh cấp độ I. Điểm trung bình trên bài kiểm tra thực hành này là 80. Giả sử độ lệch chuẩn của tổng thể là 15, hãy xây dựng và diễn giải khoảng tin cậy 99\% cho điểm trung bình trên bài kiểm tra thực hành cho 36 thí sinh. *Lưu ý rằng trong ví dụ này, độ lệch chuẩn của tổng thể được biết, vì vậy chúng ta không phải ước lượng nó.*

**Trả lời:**
Ở mức độ tin cậy 99\%, $$z_{\alpha/2} = 2.00$$ nên $$\alpha = 0.02$$, do đó $$z = 2.58$$. Vì vậy, khoảng tin cậy 99\% được tính như sau:

$$
\bar{x} \pm z_{\alpha/2} \frac{\sigma}{\sqrt{n}} = 80 \pm 2.58 \frac{15}{\sqrt{36}} = 80 \pm 6.45
$$

Do đó, khoảng tin cậy 99\% dao động từ 73.55 đến 86.45.
:::

:::info[**VÍ DỤ: Khoảng tin cậy cho trung bình tổng thể và cho một quan sát đơn lẻ**]
Lợi nhuận hàng năm trên cổ phiếu năng lượng phân phối xấp xỉ theo phân phối chuẩn với trung bình là 9\% và độ lệch chuẩn là 6\%. Hãy xây dựng khoảng tin cậy 90\% cho lợi nhuận hàng năm của một cổ phiếu năng lượng được chọn ngẫu nhiên và khoảng tin cậy 90\% cho trung bình của lợi nhuận hàng năm cho một mẫu gồm 12 cổ phiếu năng lượng.

**Trả lời:**
Một khoảng tin cậy 90\% cho một quan sát đơn lẻ là 1.645 độ lệch chuẩn từ trung bình mẫu.

$$
9\% \pm 1.645(6\%) = -0.87\% \text{ đến } 18.87\%
$$

Một khoảng tin cậy 90\% cho trung bình tổng thể là 1.645 sai số chuẩn từ trung bình mẫu.
...
Các khoảng tin cậy có thể được diễn giải theo quan điểm xác suất hoặc quan điểm thực tiễn. Liên quan đến kết quả của ví dụ bài kiểm tra thực hành CFA® này, hai quan điểm này có thể được mô tả như sau:

- **Diễn giải xác suất.** Sau khi lấy mẫu lặp đi lặp lại các thí sinh CFA, thực hiện bài kiểm tra thực hành, và xây dựng các khoảng tin cậy cho điểm trung bình của mỗi mẫu, 99\% các khoảng tin cậy kết quả sẽ, trong dài hạn, bao gồm trung bình tổng thể.
- **Diễn giải thực tiễn.** Chúng tôi tự tin 99\% rằng điểm trung bình tổng thể nằm giữa 73.55 và 86.45 cho các thí sinh từ tổng thể này.