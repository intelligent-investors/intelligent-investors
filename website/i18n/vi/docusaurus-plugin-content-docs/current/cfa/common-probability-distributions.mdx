...
Hình sau đây minh họa một ví dụ về hàm phân phối tích lũy (cho phân phối chuẩn, được mô tả sau trong chủ đề này). Có xác suất 15.87\% của một giá trị nhỏ hơn -1. Đây là tổng diện tích bên trái của -1 trong pdf ở Panel (a), và giá trị trục y của cdf cho một giá trị của -1 trong Panel (b).
